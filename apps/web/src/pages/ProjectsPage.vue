        ...
        <q-card class="q-mb-xl shadow-2 rounded-borders">
            <q-card-section>
                ...
                <div class="row q-col-gutter-md">
                    ...
                    <div class="col-12 col-md-4">
                        <q-input outlined v-model="form.description" label="Description (Optional)" dense
                            bg-color="white" />
                    </div>
                    <div class="col-12 col-md-2">
                        <q-select outlined v-model="form.language" :options="languageOptions" label="Language" dense
                            emit-value map-options bg-color="white" />
                    </div>
                    <div class="col-12 col-md-2 flex items-center">
                        <q-btn unelevated color="primary" icon="add" label="Create" :disable="!form.name"
                            :loading="isCreating" @click="createProject" class="full-width" />
                    </div>
                </div>
            </q-card-section>
        </q-card>
                            ...
                            <q-btn flat round dense color="grey-5" icon="more_vert" @click.stop>
                                <q-menu>
                                    <q-list style="min-width: 100px">
                                        <q-item clickable v-close-popup @click="deleteProject(p.id)"
                                            class="text-negative">
